...
export class HomeComponent {
  ...
  ngOnInit() {
    ...
    this.authService.usuario$.subscribe((usuario: Usuario) => {
      ...
      this.nombreCompleto = usuario.nombreCompleto;  // Asignar el nombre completo del usuario
      this.userType = usuario.tipo;  // Asignar el tipo de usuario (Estudiante o Profesor)
    });
  }
